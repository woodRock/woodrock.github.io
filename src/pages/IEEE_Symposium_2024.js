...
const IEEE_Symposium_2024 = () => {
  ...
  return (
    ...
    >
      ...
      <h4>2024 IEEE Postgraduate Symposium</h4>
      <p>
        This event is held each year with 30+ attendants, which provides excellent opportunities for postgraduate students to practice their presentation skills and network with colleagues.
        By attending the symposium, you can give a presentation (approx. 8 mins talk + 2 mins Q/A) about your research and expand your knowledge from others’ presentations.
        Other benefits include:
        <ul>
          <li>1-year free IEEE Graduate Student Membership</li>
          <li>Cash awards for top-ranked presentations</li>
          <li>Free food (lunch, morning tea and afternoon tea)</li>
          <li>Excellent networking opportunities</li>
          <li>Certificate of attendance</li>
        </ul>
        See{" "}
        <a href="https://r10.ieee.org/nzc/event/2024-ieee-postgraduate-symposium/" target="_blank" rel="noreferrer">
          IEEE Symposium 2024
        </a>{" "}
...
export default IEEE_Symposium_2024;
