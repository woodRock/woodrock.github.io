  ...
  return (
    <div class="relative group w-full">
      ...
      {isFullscreen && (
        ...
        >
          {/* Header Bar */}
          <div class="flex-shrink-0 flex justify-between items-center px-6 py-4 border-b border-white/10 bg-zinc-900" style={{ zIndex: 10000 }}>
            ...
            <div class="flex items-center">
              ...
              >
                <span class="text-[10px] font-black uppercase tracking-widest text-white">Exit Reader</span>
